    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='myproject_user_set', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='myproject_permission_set', to='auth.permission')),
            ],
            options={
                'abstract': False,
            },
